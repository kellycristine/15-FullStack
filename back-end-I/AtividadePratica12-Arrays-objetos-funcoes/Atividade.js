...
const posicaoEva = pessoas.findIndex(nome => nome === 'Eva Trindade');

console.log(`A posição de Eva Trindade é: ${posicaoEva}`);

// 9. Utilize a função filter, para filtrar todas pessoas que o nome possua o
// sobrenome "Silva".
listaFuncionarios = pessoas.filter(function (pessoa) {
  return pessoa.nome === "Silva";
});
...
nomesFormatados.forEach(nomeFormatado => {
